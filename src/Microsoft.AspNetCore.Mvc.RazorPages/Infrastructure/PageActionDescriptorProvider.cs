...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    ...
    {
        private static readonly string IndexFileName = "Index" + RazorProject.RazorExtension;
        ...
        {
            var model = new PageModel(item.CombinedPathWithoutExtension, item.PathWithoutExtension);
            model.Selectors.Add(CreateSelectorModel(item.CombinedPathWithoutExtension, template));
